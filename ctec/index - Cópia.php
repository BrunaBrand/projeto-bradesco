...
<?php 
	// Criando a consulta
$query_rs_curso = "SELECT * FROM tb_cursos WHERE ativo = 1 AND home = 1 ORDER BY idCurso DESC";
...
<title>CTec - Curso de Tecnologia</title>
...
<body>
<main>
	<h1 class="fonte-zero">CTec- Curso de Tecnologia</h1>
 <header>
<!--Topo site-->
