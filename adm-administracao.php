...
<?php 
	// Criando a consulta
$query_rs_curso = "SELECT * FROM tb_cursos WHERE ativo = 1 AND areaAdm = 1 ORDER BY idCurso DESC";
...
<title>Adm - Administração - CTec- Curso de Tecnologia</title>
...
<body>
<main>
	<h1 class="fonte-zero">Adm - Administração - CTec- Curso de Tecnologia</h1>
 <header>
<!--Topo site-->
...
<!--Menu-->	
	...
	<div class="alert alert-dark text-center" role="alert"><a href="adm-administracao.php" class="alert-link"></a>
		<h2>Administração</h2>
</div>
