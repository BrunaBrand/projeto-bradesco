...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Maio-2022 às 21:55
...
(66, 'ghfg', '', '', '', 0, '', '', 0, 0, 0, '0.00', 'bootstrap-g.jpg', '', '', 0, 0, 0, 0),
(67, 'hyt', '', '', '', 0, '', '', 0, 0, 0, '0.00', 'bootstrap-g.jpg', 'hgfh', '', 0, 0, 0, 0);
...
--
ALTER TABLE `tb_cursos`
  MODIFY `idCurso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
